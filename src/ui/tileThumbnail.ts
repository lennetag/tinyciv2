...
const PREVIEW_FRUSTUM = 4.6;

export class TileThumbnailView {
  ...
  constructor() {
    ...
    this.element.className = "hud__tile-thumbnail";

    this.canvas = document.createElement("canvas");
    this.canvas.className = "hud__tile-thumbnail-canvas";
    ...
    this.camera.lookAt(new Vector3(0, 0.42, 0));
